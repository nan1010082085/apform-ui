/**
 * BreadcrumbNav — 展示源：playground/BreadcrumbNavDemo.vue
 * 与真实业务用法同源，禁止另写假 demo。
 */
import type { Meta, StoryObj } from '@storybook/vue3-vite'
import PlaygroundDemo from '../../../../playground/src/views/BreadcrumbNavDemo.vue'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '展示内容来自 playground `BreadcrumbNavDemo.vue`，样式栈与业务应用一致。',
      },
    },
  },
