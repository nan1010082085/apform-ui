/**
 * PageHeader — 展示源：playground/PageHeaderDemo.vue
 * 与真实业务用法同源，禁止另写假 demo。
 */
import type { Meta, StoryObj } from '@storybook/vue3-vite'
import PlaygroundDemo from '../../../../playground/src/views/PageHeaderDemo.vue'
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '展示内容来自 playground `PageHeaderDemo.vue`，样式栈与业务应用一致。',
      },
    },
  },
